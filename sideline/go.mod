module github.com/flipkart-incubator/go-dmux/sideline

go 1.12

require github.com/flipkart-incubator/go-dmux/metrics v0.0.0

require github.com/flipkart-incubator/go-dmux/config v0.0.0
