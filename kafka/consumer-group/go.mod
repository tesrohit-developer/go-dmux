module github.com/flipkart-incubator/go-dmux/kafka/consumer-group

go 1.12

require github.com/flipkart-incubator/go-dmux/kafka v0.0.0

require (
	github.com/Shopify/sarama v1.20.1
	github.com/flipkart-incubator/go-dmux/metrics v0.0.0
)
